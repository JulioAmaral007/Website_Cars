    ...
    <div className="Home">
      ...
      <section class="home" id="home">
        ...
        <div class="Porsche">
          ...
          <p>
            <FaBolt color="hsl(219, 69%, 56%)" margin=".2rem" /> Eletric Car
          </p>
          <img src={home} />
          <div class="dados">
      ...
      <section class="about" id="about">
        ...
        <div class="about-car">
          ...
          <p>
            See the future with high-performance eletric cars produced by
        ...
        <div class="amostras">
          <div class="card">
            ...
            <div class="card-info">
              ...
              <p>
                <FaCloudscale margin="1rem" /> 2.7 s
                <FaTachometerAlt margin="2rem" /> 330 km/h <br />
                <FaBolt margin="1rem" /> Eletric
              </p>
            </div>
          </div>
        ...
        <div class="amostras">
          <div class="card">
            ...
            <div class="card-info">
              <h2>Tesla Model X</h2>
              <p>
                <FaCloudscale margin="2rem" /> 2.5 s
      ...
      <footer>
        ...
        <div class="follow-us">
          ...
          <li>
            <a href="#">
              <FaInstagram fontSize="25px" padding="2rem" />
            </a>
          </li>
        </div>
      </footer>
